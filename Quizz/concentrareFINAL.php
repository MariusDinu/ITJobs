...
<head>
    ...
    <title>Test de concentrare</title>
    ...
    <main class="min-h-screen overflow-hidden bg-gray-200">
        <div class="w-10/12 h-auto max-w-4xl mx-auto">
            <div class="h-auto max-w-4xl mx-auto mt-5 mb-10 border border-gray-400 rounded-lg shadow appearance-none bg-ternary">
                <h1 class="m-5 text-4xl text-white">Test de concentrare</h1>
    ...
    function result() {
        ...
        if (parseInt(checkAllInput()) == parseInt(raspunsuri.length / 4)) {
            ...
            if (rate < 10) {
                ...
                window.alert("Te descurci sa iti imparti cerintele astfel incat sa nu trebuiasca sa faci 2 lucruri simultan, insa nici asta nu ar fi o mare problema.");
            }
            rate = 0;
        } else {
