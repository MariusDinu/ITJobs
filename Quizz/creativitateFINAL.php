...
<head>
    ...
    <title>Test de creativitate</title>
    ...
    <main class="min-h-screen overflow-hidden bg-gray-200">
        <div class="w-10/12 h-auto max-w-4xl mx-auto">
            <div class="h-auto max-w-4xl mx-auto mt-5 mb-10 border border-gray-400 rounded-lg shadow appearance-none bg-ternary">
                <h1 class="m-5 text-4xl text-white">Test de creativitate</h1>
                <div class="h-auto max-w-4xl p-5 mx-auto mt-5 bg-white border border-gray-400 rounded-bl-lg rounded-br-lg shadow appearance-none md:p-10">
                    <form id="formaIntrebari" class="flex flex-col">
                        <?php
                        $items = simplexml_load_file("testCreativitateFINAL.xml") or die("Error: Cannot create object");
                        $i = 0;
                        ...
                        foreach ($items as $item) {
                            if ($i < 5) {
                                ...
                                print $ans4;
                                print "</p>";
                                print "<p><INPUT TYPE = 'Radio' Name ='$i' value= '5' class='mr-2' >";
                                print $ans5;
                                print "</p>";
...
<script>
    ...
    function result() {
        ...
        if (parseInt(checkAllInput()) == parseInt(raspunsuri.length / 5)) {
            ...
            if (rate < 13) {
                window.alert("Esti o persoana directa, nu iti place sa citesti printre randuri. Cauti raspunsuri clare si directe. ");
            } else if (rate > 18) {
                window.alert("Esti o persoana cu multa imaginatie. Intelegi lucrurile abstracte mai bine decat oricine altcineva.");
            } else {
                window.alert("Iti place sa traiesti prin personajele tale preferate, dar in viata ta stai retras. Traieste-ti viata!");
            }
            rate = 0;
        } else {
