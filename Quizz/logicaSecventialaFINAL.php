...
<head>
    ...
    <title>Test de logica secventiala</title>
    ...
    <main class="min-h-screen overflow-hidden bg-gray-200">
        <div class="w-10/12 h-auto max-w-4xl mx-auto">
            <div class="h-auto max-w-4xl mx-auto mt-5 mb-10 border border-gray-400 rounded-lg shadow appearance-none bg-ternary">
                <h1 class="m-5 text-4xl text-white">Test de logica secventiala</h1>
                <div class="h-auto max-w-4xl p-5 mx-auto mt-5 bg-white border border-gray-400 rounded-bl-lg rounded-br-lg shadow appearance-none md:p-10">
                    <form id="formaIntrebari" class="flex flex-col">
                        <?php
                        $items = simplexml_load_file("testLogicaSecventialaFINAL.xml") or die("Error: Cannot create object");
                        $i = 0;
                        ...
                        foreach ($items as $item) {
                            if ($i < 5) {
                                ...
                                if ($item[0]->answer1->attributes() == 'y') {
                                    $ans = $item[0]->answer1;
                                    print "<p><INPUT TYPE = 'Radio' Name ='$i' value= '";
                                    print $ans['correct'];
                                    print "' class='mr-2'>";
                                    print $ans1;
                                    print "</p>";
                                    print "<p><INPUT TYPE = 'Radio' Name ='$i' value= '' class='mr-2'>";
                                    print $ans2;
                                    print "</p>";
                                    print "<p><INPUT TYPE = 'Radio' Name ='$i' value= '' class='mr-2'>";
                                    print $ans3;
