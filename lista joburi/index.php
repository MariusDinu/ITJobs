...
<body>
  <!-- Navbar-->
  <nav
    class="flex flex-col items-center p-4 bg-white border-t-2 border-b-4 md:flex-row md:justify-around md:items-center text-primary font-primary border-grey-500">
    <a href="../../lista joburi/index.html" class="font-bold text-grey-800 md:text-2xl">
      <p>it-jobs</p>
    </a>
    ...
    <div class="flex flex-col items-center pt-5 md:flex-row md:mx-5 md:pt-0">
      ...
      <a href="#" class="py-2 md:mx-5">
        <span class="px-3 py-1 border-2 rounded-md border-secondary text-primary hover:bg-secondary"> Cont nou</span>
      </a>
      ...
      <div id="languageMenu" class="relative inline-block text-left">
        ...
        <div class="absolute right-0 w-56 mt-5 origin-top-right rounded-md shadow-lg">
